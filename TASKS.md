...
- [ ] **手作り誤答＋語釈の精度チェック** - 誤答600語とその語釈600件。近すぎて正解になりうるもの、非一般的な語、語釈の誤りを潰す
...
- [x] ~~答え合わせ画面に全4語の語釈~~ (2026-08-28) - distractors を {word,gloss} に。誤答の語釈600件を手作り。回答後に4語すべての意味を表示。テスト48件緑
