...
- [ ] **意味ドメインの精度上げ** - 197/200語に大分類を付与済み。より紛らわしい小クラスタ（類義語）を作ると4択がさらに難化する
...
- [x] ~~4択の誤答が簡単すぎる問題を修正~~ (2026-08-28) - 意味ドメインを197/200語に付与(字数別に各4語以上)＋語釈キーワードの近さで並べ替え。無関係な誤答が出ないように。テスト45件緑
