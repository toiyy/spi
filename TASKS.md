...
- [ ] **意味グループの見直し** - 現状142/200語に付与。未分類58語と2語グループを充実させると4択の質が上がる
...
- [x] ~~4択モードを追加~~ (2026-08-28) - 意味→語を4択で選ぶ。誤答は意味グループ(`idiom.group`)＋同字数から自動選定。`lib/choices.ts`(TDD 9件)、ホームでモード切替。テスト44件緑
